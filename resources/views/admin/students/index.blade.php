    ...
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                        ...
                        <div class="flex items-center gap-5">
                            <div class="flex gap-[10px] items-center">
                                ...
                                <p class="font-semibold">
                                    {{ \Carbon\Carbon::parse($course->created_at)->format('d F Y') }}</p>
                            </div>
                            <div class="flex gap-[10px] items-center">
                                <div class="w-6 h-6 flex shrink-0">
                ...
                <div class="relative">
                    <a href="{{ route('course.course_students.create', $course) }}"
                    ...
                    @forelse ($students as $student)
                        <div
                            ...
                            @elseif ($student->status === 'Not Started')
                                <div class="flex items-center gap-[14px]">
                                    <p
                                        class="p-[6px_10px] rounded-[10px] bg-slate-800 font-bold text-xs text-white outline-[#FD445E] outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">
                                        Not Started
                                    </p>
                                </div>
                            @else
